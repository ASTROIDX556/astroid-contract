...
pub enum Error {
    ...
    InvalidNonce = 68,
    /// A signer with zero (or otherwise invalid) weight, or accumulated
    /// approval weight below the configured threshold.
    ...
    // --- Treasury allowances (83-86) ---
    AllowanceExceeded = 83,
    AllowanceExpired = 84,
    AllowanceNotFound = 85,
    AllowanceAlreadyExists = 86,
}
